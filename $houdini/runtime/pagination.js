...
export function paginatedFragment(document, initialValue) {
	...
	const typeConfig =
		(_a = document.config.types) === null || _a === void 0 ? void 0 : _a[targetType || ''];
	if (!typeConfig) {
		throw new Error(
	...
	if (paginationArtifact.refetch.embedded) {
		...
		if ((_b = typeConfig.resolve) === null || _b === void 0 ? void 0 : _b.arguments) {
			queryVariables = () => {
				var _a, _b;
				return (
					((_b = (_a = typeConfig.resolve).arguments) === null || _b === void 0
						? void 0
						: _b.call(_a, initialValue)) || {}
				);
			};
		} else {
...
function cursorHandlers({
	...
	const initialPageInfo =
		(_a = extractPageInfo(initialValue, artifact.refetch.path)) !== null && _a !== void 0
			? _a
			: {
					startCursor: null,
					endCursor: null,
	...
	const loadPage = async ({ pageSizeVar, input, functionName }) => {
		...
		if (artifact.refetch.embedded) {
			...
			if (
				!((_b = (_a = config.types) === null || _a === void 0 ? void 0 : _a[targetType]) === null ||
				_b === void 0
					? void 0
					: _b.resolve)
			) {
	...
	return {
		...
		async refetch(input) {
			...
			const count =
				countPage(artifact.refetch.path.concat('edges'), value) || artifact.refetch.pageSize;
			// build up the variables to pass to the query
			const queryVariables = {
				...variables(),
				...extraVariables,
