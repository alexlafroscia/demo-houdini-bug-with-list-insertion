...
export declare function query<_Query extends Operation<any, any>>(
...
export declare type QueryResponse<_Data, _Input> = {
	...
	onLoad: (
		newValue: FetchQueryResult<_Data> & {
			variables: _Input;
		}
	) => void;
...
export declare const routeQuery: <_Data, _Input>({
	queryHandler,
	artifact,
	source
}: {
...
export declare const componentQuery: <_Data extends GraphQLObject, _Input>({
	config,
	artifact,
	queryHandler,
	variableFunction,
