	...
	get(id, field) {
		...
		for (let i = this.data.length - 1; i >= 0; i--) {
			...
			layer.deletedIDs.forEach((v) => {
				...
				if (
					(_b =
						(_a = layer.operations[v]) === null || _a === void 0
							? void 0
							: _a.undoDeletesInList) === null || _b === void 0
						? void 0
						: _b.includes(field)
				) {
					return;
...
export class Layer {
	...
	get(id, field) {
		...
		if (
			typeof ((_a = this.links[id]) === null || _a === void 0 ? void 0 : _a[field]) !== 'undefined'
		) {
	...
	getOperations(id, field) {
		...
		if (
			(_c = (_b = this.operations[id]) === null || _b === void 0 ? void 0 : _b.fields) === null ||
			_c === void 0
				? void 0
				: _c[field]
		) {
	...
	writeLink(id, field, value) {
		...
		for (const value of flattenList(valueList)) {
			...
			const fieldOperations =
				(_a = this.operations[id]) === null || _a === void 0 ? void 0 : _a.fields[field];
			// if the operation was globally deleted
			if (
				((_b = this.operations[value]) === null || _b === void 0 ? void 0 : _b.deleted) ||
				this.deletedIDs.has(value)
			) {
				// undo the delete
				this.operations[value] = {
					...this.operations[value],
					undoDeletesInList: [
						...(((_c = this.operations[id]) === null || _c === void 0
							? void 0
							: _c.undoDeletesInList) || []),
						field
					]
				};
				...
				value &&
				(fieldOperations === null || fieldOperations === void 0 ? void 0 : fieldOperations.length) >
					0
			) {
	...
	addFieldOperation(id, field, operation) {
		...
		this.operations = {
			...
			[id]: {
				...
				fields: {
					[field]: [
						...(((_a = this.operations[id]) === null || _a === void 0
							? void 0
							: _a.fields[field]) || []),
						operation
					]
