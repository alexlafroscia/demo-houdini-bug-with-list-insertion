...
export class ListManager {
	...
	get(listName, id) {
		var _a;
		return (_a = this.lists.get(listName)) === null || _a === void 0
			? void 0
			: _a.get(id || this.rootID);
	}
	remove(listName, id) {
		var _a;
		(_a = this.lists.get(listName)) === null || _a === void 0
			? void 0
			: _a.delete(id || this.rootID);
	}
	add(list) {
		var _a, _b, _c;
		...
		if (
			(_b = (_a = this.lists.get(name)) === null || _a === void 0 ? void 0 : _a.get(parentID)) ===
				null || _b === void 0
				? void 0
				: _b.includes(list.key)
		) {
			return;
		}
		...
		if (!this.listsByField.get(list.recordID).has(list.key)) {
			(_c = this.listsByField.get(list.recordID)) === null || _c === void 0
				? void 0
				: _c.set(list.key, []);
		}
	...
	deleteField(parentID, field) {
		...
		if (
			!((_a = this.listsByField.get(parentID)) === null || _a === void 0 ? void 0 : _a.has(field))
		) {
			return;
		}
		...
		for (const list of this.listsByField.get(parentID).get(field)) {
			(_c =
				(_b = this.lists.get(list.name)) === null || _b === void 0
					? void 0
					: _b.get(list.parentID)) === null || _c === void 0
				? void 0
				: _c.deleteListWithKey(field);
			if (
				((_e =
					(_d = this.lists.get(list.name)) === null || _d === void 0
						? void 0
						: _d.get(list.parentID)) === null || _e === void 0
					? void 0
					: _e.lists.length) === 0
			) {
				(_f = this.lists.get(list.name)) === null || _f === void 0
					? void 0
					: _f.delete(list.parentID);
			}
		}
	...
	validateWhen(when) {
		...
		if (filters) {
			...
			if (filters.must_not) {
				ok =
					!targets ||
					Object.entries(filters.must_not).reduce(
						(prev, [key, value]) => Boolean(prev && targets[key] != value),
						ok
					);
			}
